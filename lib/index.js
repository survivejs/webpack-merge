...
function merge() {
  ...
  return lodashMerge.apply(null, [{}].concat(args).concat([joinArrays.bind(null, function () {})]));
}

function mergeSmart() {
  var args = Array.prototype.slice.call(arguments);

  return lodashMerge.apply(null, [{}].concat(args).concat([joinArrays.bind(null, function (a, b, key) {
    if (isLoader(key)) {
